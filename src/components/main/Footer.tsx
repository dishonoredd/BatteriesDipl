import FooterBot from "../ui/footer/FooterBot";
import FooterNav from "../ui/footer/FooterNavI";

export default function Footer() {
  return (
    <footer className="bg-neutral-900 mt-16">
      <div className="max-w-400 mx-auto px-4 sm:px-6 py-10 sm:py-12 md:py-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">info@akb-sochi.ru</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Профессиональная продажа аккумуляторов в Сочи с 2010 года. Широкий
              ассортимент, низкие цены, быстрая доставка по городу и районам.
            </p>
