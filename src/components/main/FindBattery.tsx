  ...
  return (
    <section className="max-w-400 mx-auto py-16 px-4 sm:px-6 md:px-8">
      <div className="bg-white rounded-2xl shadow-md p-12 text-center">
        ...
        <Link
          href={SELECTION_PATH}
          className="max-sm:text-[13px] sm:text-lg inline-flex items-center justify-center px-8 py-3 bg-gray-800 text-white  rounded-xl hover:bg-gray-900 transition duration-200 shadow-md hover:shadow-lg gap-2"
        >
